          ...
          <a className="group rounded-xl overflow-hidden dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">
            <div className="sm:flex">
              ...
              <div className="grow mt-4 sm:mt-0 sm:ms-6 px-4 sm:px-0">
                ...
                By Alycia Steelman, Founder of Ascension Educational Services The looming threat of “college prep” can feel foggy without the proper guidance through the process. Meetings with guidance counselors, teachers, and tutors relate an often shifting timeline of practice tests, interviews, essay writing and recommendations. This process can be both intellectually and emotionally overwhelming for students. 
                </p>
